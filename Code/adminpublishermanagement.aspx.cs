...
namespace ELibraryManagement
{
    public partial class adminpublishermanagement : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('Publisher with this ID already Exists. Cannot add duplicate IDs');</script>");
            }
            else
            {
                addNewPublisher();
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('Publisher Does not Exists. Please Enter a Valid Publisher ID');</script>");
            }
        }
        //Delete Button
