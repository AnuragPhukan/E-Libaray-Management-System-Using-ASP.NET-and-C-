                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                    <div class="col">
                                        <center>
                                            ...
                                            <asp:Label class="badge rounded-pill bg-info text-dark" ID="Label1" runat="server" Text="Your status">
                           ...
                           <div class="row">
                                    <div class="col">
                                         <center>
                                            <button type="button" class="btn btn-primary">
                                             Login Credentials <span class="badge badge-light"></span>
                                            </button>   
                                          </center>
                                    </div>
                            </div>
                                    ...
                                    <div class="col-md-4">
                                     ...
                                     <div class="col-md-4">
                                         <label> New Password </label>
                                            <h1></h1>
                                            <div class="form-group">
                                               <asp:TextBox Class="form-control" ID="TextBox10" runat="server" placeholder="Email ID" TextMode="Password" ReadOnly="False"></asp:TextBox>       
                                              </div>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group">
                                                <asp:Button class="btn btn-primary btn-lg w-100" ID="Button1" runat="server" Text="Update" OnClick="Button1_Click" />
                                            <h1></h1>
                                            </div>
                                    </div>
                                 </div>
                ...
                <div class="col-md-7">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                    <div class="col">
                                        <center>
                                            ...
                                            <asp:Label class="badge rounded-pill bg-info text-dark" ID="Label2" runat="server" Text="Info on your books">
                            ...
                            <div class="row">
                                <asp:SqlDataSource ID="SqlDataSource1" runat ="server" ConnectionString="<%$ ConnectionStrings:eLibraryDBConnectionString7 %>" SelectCommand="SELECT * FROM [book_issue_tbl]"></asp:SqlDataSource>
                                    <div class="col">
