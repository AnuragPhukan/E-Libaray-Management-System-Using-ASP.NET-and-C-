...
namespace ELibraryManagement
{
    public partial class signup : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('User Already Exists. Please Enter a different ID ');</script>");
            }
           else
            {
                signUpNewUser();
        ...
        void signUpNewUser()
        {
            try
            {
                ...
                cmd.ExecuteNonQuery();
                con.Close();
                Response.Write("<script>alert('Sign Up Successful. Go to the User Login to Login');</script>");
